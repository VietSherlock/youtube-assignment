...
export class VideoDataService {
  ...
  videos:Array<Video> = [
    ...
    },
    {
      id: 5,
      type:"Sport",
      title: 'POGBA PHIÊN BẢN “PRIME” SẼ GIÚP MAN UTD VÔ ĐỊCH PREMIER LEAGUE? | TACTICS (15)',
      author: 'Random Football',
      url: 'https://www.youtube.com/embed/idg9hjgQ-k4',
      avatarurl: 'https://yt3.ggpht.com/m2K8H1avtC9FpxvDSbQgl3LDCewCbe5rZjqaOW26mO4ljQmiPWctI0FUvPsKZrfpltfv2lL7GFE=s68-c-k-c0x00ffffff-no-rj',
      pictureURL:"https://i.ytimg.com/vi/idg9hjgQ-k4/hq720.jpg?sqp=-oaymwEcCNAFEJQDSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&rs=AOn4CLD4FWI97vojLlf7vOZJNGJ4bC6ZWA",
      view: 3080865 ,
      like: 59001,
      dislike: 0,
